...
<html lang="zh">
	...
	<body class="account-body">
		...
		<div id="landing-header-id" class="landing-body" onscroll="scrollFunction()">
			...
			<script src="../app/public/eyt_register_new_check.js" charset="utf-8"></script>
		    <script src="../app/public/eyt_register_new_c.js" charset="utf-8"></script>
			<script src="../app/public/eyt_register_new_m.js" charset="utf-8"></script>  
			<script src="../app/public/eyt_register_new_v.js" charset="utf-8"></script>
