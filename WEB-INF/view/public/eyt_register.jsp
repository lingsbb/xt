...
<html lang="zh">
	...
	<body class="account-body">
		...
		<div id="landing-header-id" class="landing-body" onscroll="scrollFunction()">
									...
									<div  class="cr-ai-ld-td">
										<div id="divCheck" class="cr-ai-ld-ls-lt">
							                ...
							                <label id="txtTel-error1" style="display:none" >请输入一个有效的手机号！</label>
               								...
               								<label id="txtNickname-error1" style="display:none" >请输入中文昵称！</label>
               								<label id="txtNickname-error2" style="display:none" >昵称已注册！</label>
               								<label id="txtPassword-error1" style="display:none" >密码6位且只能是英文和数字！</label>
               								<label id="txtRepassword-error1" style="display:none" >密码不一致！</label>
               								<label id="txtQiye-error1" style="display:none" >请输入正确的企业名称！</label>
										</div>
										...
										<div class="cr-ai-ld-ho"><input id="txtNickname" name="txtNickname" type="text" class="cr-ai-ld" placeholder="请输入昵称" /></div>
										
										<div class="cr-ai-ld-ho"><input id="txtPassword" name="txtPassword" type="password" class="cr-ai-ld" placeholder="请输入密码" ></div>
										
										<div class="cr-ai-ld-ho"><input id="txtRepassword" name="txtRepassword" type="password" class="cr-ai-ld" placeholder="请再次输入密码" ></div>
										
										<div class="cr-ai-ld-ho"><input id="txtQiye" name="txtQiye" type="text" class="cr-ai-ld" placeholder="请输入企业名称" ></div>
			...
			<div class="copyright">
				<div class="container">Copyright © 2016-2017 哈尔滨俄运通科贸有限公司 · 哈152备1500**7号</div>
			</div>
		</div>
			...
			<script src="../app/public/register_check.js" charset="utf-8"></script>
		    <script src="../app/public/register_c.js" charset="utf-8"></script>
			<script src="../app/public/register_m.js" charset="utf-8"></script>  
			<script src="../app/public/register_v.js" charset="utf-8"></script>
