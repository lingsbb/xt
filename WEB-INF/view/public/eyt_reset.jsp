...
<html lang="zh">
	...
	<body class="account-body">
		...
		<div id="landing-header-id" class="landing-body" onscroll="scrollFunction()">
							...
							<div data-reactroot="" class="d-ai-ho">
								<div class="d-ai-lr">
									...
									<div  class="cr-ai-ld-td">
										...
										<div class="cr-ai-ld-ho"><input id="txtPassword" placeholder="请输入密码" value="" type="password"  class="cr-ai-ld"></div>
										
										<div class="cr-ai-ld-ho"><input id="txtRepassword" type="password" value="" placeholder="请再次输入密码" class="cr-ai-ld"></div>
										...
										<div id="btnOK" class="d-ai-rt">确 定</div><input type="text" name="fakeusernameremembered" style="display: none;"><input type="password" name="fakepasswordremembered" style="display: none;"></div>
										<div class="cr-ai-dr-xj">
									<!-- <a id="resetPassword" class="cr-ai-dr-xj-h" >忘记密码</a>
										<a target="_self" href="../public/eyt_register" class="cr-ai-dr-xj-h" >注册</a> -->
									</div>
								</div>
							</div>
						</div>
		    ...
		    <script src="../app/public/reset_c.js" charset="utf-8"></script>
			<script src="../app/public/reset_m.js" charset="utf-8"></script>  
			<script src="../app/public/reset_v.js" charset="utf-8"></script>
			<script src="../app/public/reset_check.js" charset="utf-8"></script>
