...
<body>
	...
	<div class="mui-content own-content-padding">
		<div class="mui-card" style="margin-top: 30px;">
			<form class="mui-input-group">
				<div class="mui-input-row">
					...
					</label> <input id="password"  class="mui-input-clear" type="password"
						placeholder="输入原密码" />
				</div>
				<div class="mui-input-row">
					<label><span class="mui-icon iconfont icon-mimaxiugai"></span>
					</label> <input id="new_password" class="mui-input-clear" type="password"
						placeholder="输入新密码" />
				</div>
				<div class="mui-input-row">
					<label><span class="mui-icon iconfont icon-queren"></span>
					</label> <input id="re_new_password"  class="mui-input-clear" type="password"
						placeholder="确认新密码" />
				</div>
			</form>
		</div>
		<div class="mui-button-row" style="margin: 10px 15px;">
			<button  id="btn_register" type="button"
				...
				style="padding: 5px 0px;width: 100%;height: 40px;" onclick="updatePassword();">修改</button>
		</div>
	</div>
	...
	<script src="front/mobile/update_password.js" charset="UTF-8"></script>
