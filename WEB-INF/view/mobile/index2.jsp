		...
		<div id="tabbar" class="mui-control-content mui-active">
			...
			<div id="slider" class="mui-slider">
				<div class="mui-slider-group mui-slider-loop">
					...
					<div class="mui-slider-item mui-slider-item-duplicate">
						<a href="redbag">
							<img height="170px" src="front/images/red.jpg">
						</a>
					</div>
					...
					<a >
						<div class="bgDiv">
							...
							<div class="mui-media-body">
								...
								<p id="nowPrice1" class="price-one">¥11&nbsp;<span id="price1" style="text-decoration:line-through;font-size: small;">15.8</span></p>
								<div class="price-two">
									<span id="discount1" class="mui-badge mui-badge-danger">79折</span>
								</div>
							</div>
						</div>
					</a>
					...
					<a href="#">
						<div class="bgDiv">
							...
							<div class="mui-media-body">
								...
								<p id="nowPrice2" class="price-one">¥11&nbsp;<span id="price2" style="text-decoration:line-through;font-size: small;">15.8</span></p>
								<div class="price-two">
									<span id="discount2" class="mui-badge mui-badge-danger">79折</span>
								</div>
							</div>
						</div>
					</a>
					...
					<a href="#">
						<div class="bgDiv">
							...
							<div class="mui-media-body">
								...
								<p id="nowPrice3" class="price-one">¥11&nbsp;<span id="price3" style="text-decoration:line-through;font-size: small;">15.8</span></p>
								<div class="price-two">
									<span id="discount3" class="mui-badge mui-badge-danger">79折</span>
								</div>
							</div>
						</div>
					</a>
					...
					<a href="#">
						<div class="bgDiv">
							...
							<div class="mui-media-body">
								...
								<p id="nowPrice4" class="price-one">¥11&nbsp;<span id="price4" style="text-decoration:line-through;font-size: small;">15.8</span></p>
								<div class="price-two">
									<span id="discount4" class="mui-badge mui-badge-danger">79折</span>
								</div>
							</div>
						</div>
					</a>
					...
					<a href="#">
						<div class="bgDiv">
							...
							<div class="mui-media-body">
								...
								<p id="nowPrice5" class="price-one">¥11&nbsp;<span id="price5" style="text-decoration:line-through;font-size: small;">15.8</span></p>
								<div class="price-two">
									<span id="discount5" class="mui-badge mui-badge-danger">79折</span>
								</div>
							</div>
						</div>
					</a>
					...
					<a href="#">
						<div class="bgDiv">
							...
							<div class="mui-media-body">
								...
								<p id="nowPrice6" class="price-one">¥11&nbsp;<span id="price6" style="text-decoration:line-through;font-size: small;">15.8</span></p>
								<div class="price-two">
									<span id="discount6" class="mui-badge mui-badge-danger">79折</span>
								</div>
							</div>
						</div>
					</a>
					...
					<a href="#">
						<div class="bgDiv">
							...
							<div class="mui-media-body">
								...
								<p id="nowPrice7" class="price-one">¥11&nbsp;<span id="price7" style="text-decoration:line-through;font-size: small;">15.8</span></p>
								<div class="price-two">
									<span id="discount7" class="mui-badge mui-badge-danger">79折</span>
								</div>
							</div>
						</div>
					</a>
					...
					<a href="#">
						<div class="bgDiv">
							...
							<div class="mui-media-body">
								...
								<p id="nowPrice8" class="price-one">¥11&nbsp;<span id="price8" style="text-decoration:line-through;font-size: small;">15.8</span></p>
								<div class="price-two">
									<span id="discount8" class="mui-badge mui-badge-danger">79折</span>
								</div>
							</div>
						</div>
					</a>
					...
					<a href="#">
						<div class="bgDiv">
							...
							<div class="mui-media-body">
								...
								<p id="nowPrice9" class="price-one">¥11&nbsp;<span id="price9" style="text-decoration:line-through;font-size: small;">15.8</span></p>
								<div class="price-two">
									<span id="discount9" class="mui-badge mui-badge-danger">79折</span>
								</div>
							</div>
						</div>
					</a>
					...
					<a href="#">
						<div class="bgDiv">
							...
							<div class="mui-media-body">
								...
								<p id="nowPrice10" class="price-one">¥11&nbsp;<span id="price10" style="text-decoration:line-through;font-size: small;">15.8</span></p>
								<div class="price-two">
									<span id="discount10" class="mui-badge mui-badge-danger">79折</span>
								</div>
							</div>
						</div>
					</a>
			...
			<!-- 此后是增加的1 -->
			<div align="center">
				<span class="mui-badge mui-badge-success">日用百货1</span>
			</div>
					...
					<a href="#">
						<div class="bgDiv">
							...
							<div class="mui-media-body">
								...
								<p id="nowPrice11" class="price-one">¥11&nbsp;<span id="price11" style="text-decoration:line-through;font-size: small;">15.8</span></p>
								<div class="price-two">
									<span id="discount11" class="mui-badge mui-badge-danger">79折</span>
								</div>
							</div>
						</div>
					</a>
					...
					<a href="#">
						<div class="bgDiv">
							...
							<div class="mui-media-body">
								...
								<p id="nowPrice12" class="price-one">¥11&nbsp;<span id="price12" style="text-decoration:line-through;font-size: small;">15.8</span></p>
								<div class="price-two">
									<span id="discount12" class="mui-badge mui-badge-danger">79折</span>
								</div>
							</div>
						</div>
					</a>
			...
			<!-- 此后是增加的2 -->
			<div align="center">
				<span class="mui-badge mui-badge-success">日用百货2</span>
			</div>
					...
					<a href="#">
						<div class="bgDiv">
							...
							<div class="mui-media-body">
								...
								<p id="nowPrice13" class="price-one">¥11&nbsp;<span id="price13" style="text-decoration:line-through;font-size: small;">15.8</span></p>
								<div class="price-two">
									<span id="discount13" class="mui-badge mui-badge-danger">79折</span>
								</div>
							</div>
						</div>
					</a>
					...
					<a href="#">
						<div class="bgDiv">
							...
							<div class="mui-media-body">
								...
								<p id="nowPrice14" class="price-one">¥11&nbsp;<span id="price14" style="text-decoration:line-through;font-size: small;">15.8</span></p>
								<div class="price-two">
									<span id="discount14" class="mui-badge mui-badge-danger">79折</span>
								</div>
							</div>
						</div>
					</a>
			...
			<!-- 此后是增加的3 -->
			<div align="center">
				<span class="mui-badge mui-badge-success">日用百货3</span>
			</div>
					...
					<a href="#">
						<div class="bgDiv">
							...
							<div class="mui-media-body">
								...
								<p id="nowPrice15" class="price-one">¥11&nbsp;<span id="price15" style="text-decoration:line-through;font-size: small;">15.8</span></p>
								<div class="price-two">
									<span id="discount15" class="mui-badge mui-badge-danger">79折</span>
								</div>
							</div>
						</div>
					</a>
					...
					<a href="#">
						<div class="bgDiv">
							...
							<div class="mui-media-body">
								...
								<p id="nowPrice16" class="price-one">¥11&nbsp;<span id="price16" style="text-decoration:line-through;font-size: small;">15.8</span></p>
								<div class="price-two">
									<span id="discount16" class="mui-badge mui-badge-danger">79折</span>
								</div>
							</div>
						</div>
					</a>
