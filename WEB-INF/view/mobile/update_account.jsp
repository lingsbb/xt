...
<body>
	...
	<div class="mui-content own-content-padding">
		<div class="mui-card" style="margin-top: 30px;">
			<form class="mui-input-group">
				...
				<div class="mui-input-row">
					...
					</label> <input id="new_account"  class="mui-input-clear" type="text"
						placeholder="输入新帐号" />
				</div>
			</form>
		</div>
		<div class="mui-button-row" style="margin: 10px 15px;">
			<button  id="btn_register" type="button"
				...
				style="padding: 5px 0px;width: 100%;height: 40px;" onclick="updateAccount();">修改</button>
		</div>
	</div>
	...
	<script src="front/mobile/update_account.js" charset="UTF-8"></script>
