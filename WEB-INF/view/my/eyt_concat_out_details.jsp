...
<html>
	...
	<body class="gray-bg">
		...
		<script type="text/javascript" src="../app/my/eyt_concat_out_details_c.js"></script>
		<script type="text/javascript" src="../app/my/eyt_concat_out_details_m.js"></script>
		<script type="text/javascript" src="../app/my/eyt_concat_out_details_v.js"></script>
		<script type="text/javascript" src="../app/my/eyt_concat_out_details_check.js"></script>
