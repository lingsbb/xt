				...
				<div class="col-sm-12">
					<div class="ibox float-e-margins">
						<div class="ibox-title">
							<h5>内部联系人 <small></small></h5>
							<div class="ibox-tools">
								<button id="btnAddConcatIn" name="btnAddConcatIn" class=" btn btn-info btn-xs">添加</button>
							</div>
						</div>
...
<script type="text/javascript" src="../app/my/eyt_concat_in_c.js"></script>
<script type="text/javascript" src="../app/my/eyt_concat_in_m.js"></script>
<script type="text/javascript" src="../app/my/eyt_concat_in_v.js"></script>
<script type="text/javascript" src="../app/my/eyt_concat_in_check.js"></script>