...
<link href="../css/font-awesome.min.css?v=4.4.0" rel="stylesheet">-->
	...
	<script type="text/javascript" src="../app/common/common.js"></script>-->
		...
		<script type="text/javascript" src="../app/my/eyt_concat_in_add_c.js"></script>
		<script type="text/javascript" src="../app/my/eyt_concat_in_add_check.js"></script>
		<script type="text/javascript" src="../app/my/eyt_concat_in_add_m.js"></script>
		<script type="text/javascript" src="../app/my/eyt_concat_in_add_v.js"></script>
